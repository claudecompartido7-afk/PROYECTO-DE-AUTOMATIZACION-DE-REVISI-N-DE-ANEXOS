...
## Reglas de validación consolidadas — v14
...
Los procesos conservan además `NO APLICA` (PE.03 y PS.08 ausentes), que no es un
estado de cumplimiento sino de existencia: no se puntúa ni entra en el
