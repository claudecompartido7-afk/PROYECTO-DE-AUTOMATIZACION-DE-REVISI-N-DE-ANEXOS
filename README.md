...
```
apps-script/Anexo1_Auditoria_v12.gs      Auditor del Anexo 1 — VERSIÓN VIGENTE
...
reglas/ANEXO-1_reglas-v12.md             Reglas vigentes
...
374 comprobaciones sobre las funciones puras: validadores de las columnas C a I,
...
2. Pegar el contenido de `apps-script/Anexo1_Auditoria_v12.gs`
