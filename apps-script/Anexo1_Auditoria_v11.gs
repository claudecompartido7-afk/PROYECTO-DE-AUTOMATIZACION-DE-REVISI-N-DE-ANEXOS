 ...
 *  VERSIÓN 11
 *  ─────────────────────────────────────────────────────────────────────────────
 *   [C31] Hoja `dashboard`: tablero de cifras, dos gráficos comparativos y el
 *         detalle por facultad, dentro del propio libro.
 *   [C32] Cada número del detalle es un enlace que salta a la fila exacta del
 *         bloque correspondiente en la hoja de detalle, para ver esos productos
 *         o procesos con sus observaciones.
 *   [C33] Las hojas de detalle se ordenan por facultad y, dentro de cada una,
 *         los conformes antes que los observados. Es lo que permite que el
 *         enlace de cada número apunte a una fila exacta.
 *
 *  Arrastra de la v10: una observación por renglón, catalogaciones fuera del
 *  detallado, resumen con productos sin registro.
 *
 ...
 *
 *  Especificación: reglas/ANEXO-1_reglas-v11.md
 * ═══════════════════════════════════════════════════════════════════════════════
 */
