...
function ejecutarRevisionAnexo3() {
  ...
  registrarRevision('Anexo 3', calcularPorcentajeGeneralAnexo3_(revisadas));
...
/**
 * Calcula el porcentaje general del Anexo 3 desde el array de facultades revisadas.
 * Toma el avance de cada facultad (que es solo del Anexo 3) y calcula el promedio.
 *
 * @param {Array} facultadesRevisadas - Array de objetos facultad con propiedad 'avance'
